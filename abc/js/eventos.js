var iniciaApp = function(){
	...
	var altas=function(){
		...
		var parametros ="opcion=alta"+"&usuario="+usuario+"&nombre="+nombre+"&clave="+clave+"&departamento="+depto+"&vigencia="+vigencia+"&id="+Math.random();
	...
	var bajas=function(){
		var usuario=$("#txtNomUsuario").val();
		var parametros="opcion=baja"+"&usuario="+usuario+"&id="+Math.random();
		...
		bajaUsuario.done(function(data){
			if(data.respuesta==true){
				...
				alert("Usuario no existente o no se pudo dar de baja");
			}
		});
